...
```bash
curl -i -X GET 'http://localhost:8080/api/trips' | jq
```

Fetch an existing trip with id `ea2f7ae0-3cef-49cb-b7d1-ce972113120c`.

```bash
curl -i -X GET 'http://localhost:8080/api/trips/ea2f7ae0-3cef-49cb-b7d1-ce972113120c' | jq
```
...
```bash
curl -i -X PATCH --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "AverageSpeed": 60, "FuelUsed": 12 }' 'http://localhost:8080/api/trips/8f6c3f13-b214-4f8e-917f-1385d5f1b922' | jq
...
```bash
curl -i -X GET 'http://localhost:8080/api/trips/user/hacker2' | jq
...
```bash
curl -i -X GET 'http://localhost:8080/api/trips/ea2f7ae0-3cef-49cb-b7d1-ce972113120c/trippoints' | jq
...
```bash
curl -i -X GET 'http://localhost:8080/api/trips/ea2f7ae0-3cef-49cb-b7d1-ce972113120c/trippoints/23dfc028-f84f-4230-b297-88a4bafb6c22' | jq
SLIGHTLY BROKEN - dates not serialising correctly
```
...
```bash
curl -i -X PATCH --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "Latitude": 48.67598, "Longitude": -121.10612 }' 'http://localhost:8080/api/trips/ea2f7ae0-3cef-49cb-b7d1-ce972113120c/trippoints/53dffb4b-91a4-45c2-a10e-a3b3aada3390' | jq
...
```bash
curl -i -X GET 'http://localhost:8080/api/trips/healthcheck' | jq
```